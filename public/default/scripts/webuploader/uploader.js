...
$(function () {
    ...
    $.upLoadDefaults.property = {
        ...
        filesize: "20480", //文件大小
        btntext: "浏览...", //上传按钮的文字
        sendurl: "/tools/upload_ajax.ashx?action=UpLoadFile", //上传地址
        swf: "/scripts/webuploader/uploader.swf"  //SWF上传控件相对地址
    };
    //初始化上传控件
    $.fn.InitUploader = function (b) {
        var fun = function (parentObj) {
            ...
            uploader.on('uploadSuccess', function (file, data) {
                ...
                if (data.status == '1') {
                    ...
                    if (!p.multiple) {
                        ...
                        //上传完之后预览图片
                        parentObj.siblings(".preview").attr("src", data.thumb)
                    }
                    var progressObj = parentObj.children(".upload-progress");
            ...
            uploader.on('uploadComplete', function (file) {
                ...
                //回调指定函数
                var callback = parentObj.siblings(".upload-callback").val();
